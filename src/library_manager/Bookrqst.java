 ...
 * @author user
 */
public class Bookrqst extends javax.swing.JFrame {

    /**
     * Creates new form Bookrqst
     */
    ...
    private void initComponents() {
        ...
        jScrollPane1.setMinimumSize(new java.awt.Dimension(900, 160));
        jScrollPane1.setPreferredSize(new java.awt.Dimension(900, 160));
        ...
        rqsttable.setMinimumSize(new java.awt.Dimension(900, 160));
        rqsttable.setPreferredSize(new java.awt.Dimension(900, 160));
        ...
        butviewrqst.setBackground(new java.awt.Color(153, 153, 153));
        ...
        try {
            String sql = "select * from bookrqst";
            pst = con.prepareStatement(sql);
            rs = pst.executeQuery();
            rqsttable.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bookrqst.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
