...
public class ViewBook extends javax.swing.JFrame {
    ...
    private void insertcombov() {
        ...
        coview.addItem("All");
        try {
            String st = "select bkdep from bkdepart ";
            pst = con.prepareStatement(st);
            rs = pst.executeQuery();
            while (rs.next()) {
                String s = rs.getString("bkdep");
                coview.addItem(s);
    ...
    private void initComponents() {
        ...
        butadmn1 = new javax.swing.JButton();
        ...
        booktable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Title", "Author", "Volume", "Number of copies", "Status"
            }
        ) {
        ...
        booktable.setMinimumSize(new java.awt.Dimension(900, 160));
        booktable.setRowHeight(23);
        booktable.setRowMargin(2);
        jScrollPane1.setViewportView(booktable);

        coview.setToolTipText("");
        ...
        pic.add(jTextField1);
        jTextField1.setBounds(0, 190, 800, 70);
        ...
        butadmn1.setText("Admin Panel");
        butadmn1.setPreferredSize(new java.awt.Dimension(90, 40));
        butadmn1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                butadmn1ActionPerformed(evt);
            }
        });
        ...
        butviewbook.setBackground(new java.awt.Color(153, 153, 153));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(3, 3, 3)
                .addComponent(butadmn1, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(butadmn1, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void butadmn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butadmn1ActionPerformed
        new Adminpanel().setVisible(true);
        this.setVisible(false);
        // TODO add your handling code here:
    }//GEN-LAST:event_butadmn1ActionPerformed
    ...
    private void coviewItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_coviewItemStateChanged
        if (insertion_flag == 0) {
            if (coview.getSelectedItem() == "All") {
                ...
                try {
                    String sql = "select * from book where department='" + coview.getSelectedItem() + "'";
                    pst = con.prepareStatement(sql);
                    rs = pst.executeQuery();
                    booktable.setModel(DbUtils.resultSetToTableModel(rs));
                } catch (SQLException e) {
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        try {
            if (coview.getSelectedItem() == "All") {
                String sql = "select * from book where title like '%" + search.getText() + "%'";
                pst = con.prepareStatement(sql);
                rs = pst.executeQuery();
                booktable.setModel(DbUtils.resultSetToTableModel(rs));
            } else {

                String sql = "select * from book where department='" + coview.getSelectedItem() + "' AND title like '%" + search.getText() + "%'";
                pst = con.prepareStatement(sql);
                rs = pst.executeQuery();
                booktable.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private javax.swing.JButton butadmn1;
